...
class ExtrapolateNN():
    ...
    def train(self, data_train, X, n_epochs, loss, batch_size, verbose, distribution=None, y=None, real=False, **kwargs):
        ...
        for epoch in range(1, n_epochs + 1):
            ...
            if epoch % verbose == 0 and epoch > 10:  # action every verbose epochs
                self.save_checkpoint(epoch, X, y, real)  # save parameters, losses
    ...
    # Evaluation
    # ======================
    def save_checkpoint(self, epoch, X, y, real):
        """save parameters and evaluation metrics"""
        self.eval_criterias(epoch, X, y, real)
    ...
    def eval_criterias(self, epoch, X_order, real, *args, **kwargs):
